...
export const SIDEBAR_NAV: SidebarNavItem[] = [
  ...
  { label: "IOC Lookup", icon: "fingerprint", to: "/endpoint/ioc" },
  { label: "Threat Hunting", icon: "crosshair", to: "/endpoint/hunting" },
  { label: "Vulnerability Detection", icon: "target", to: "/endpoint/vulnerabilities" },
  { label: "Security Logs / Event Monitoring", icon: "scrollText", to: "/search" },
  { label: "Network Monitoring", icon: "network", to: "/endpoint/network" },
  { label: "Process & Service Monitoring", icon: "activity", to: "/endpoint/process" },
